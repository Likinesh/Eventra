...
const ExploreDynamicRoute = () => {
  ...
  const { city, state, isValid } = !isCategory
    ...
    : { city: null, state: null, isValid: null };
  ...
  const { data: events, isLoading } = useConvexQuery(
    isCategory ? api.events.getEventByCategory : api.events.getEventByLocation,
    isCategory
      ? {
          category: slug,
          limit: 50,
...
export default ExploreDynamicRoute;
